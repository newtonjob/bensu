                ...
                <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="add-product.html#" class="btn btn-icon btn-sm btn-success flex-shrink-0 ms-4"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
...
<rect x="4.36396" y="11.364" width="16" height="2" rx="1" fill="currentColor"/>
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid " >
                ...
                <div id="kt_app_content_container" class="app-container  container-xxl ">
                    <!--begin::Form-->
                    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/keen/demo1/../demo1/apps/ecommerce/catalog/products.html">
                        <!--begin::Aside column-->
...
<rect x="6" y="11" width="12" height="2" rx="1" fill="currentColor"/>
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                                <!--begin:::Tab item-->
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="add-product.html#kt_ecommerce_add_product_general">General</a>
                                </li>
                                <!--end:::Tab item-->

                                <!--begin:::Tab item-->
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="add-product.html#kt_ecommerce_add_product_advanced">Advanced</a>
                                </li>
                                <!--end:::Tab item-->
