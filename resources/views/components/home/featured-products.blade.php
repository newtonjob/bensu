                                        ...
                                        @foreach (app('featured_products') as $product)
                                            <div class="item ovh">
                                                <div class="shop_item bdrtrb1 px-2 px-sm-3 wow fadeIn"
                                                     data-wow-duration=1.1s>
                                                    <div class="thumb pb30">
                                                        <img src="{{ cloudinary_url(config('services.cloudinary.root_product'). $product->images[0]->src, ['width' => 200]) }}" alt="{{ $product->name }} Product">
                                                        <div class=thumb_info>
                                                            <ul class=mb0>
                                                                <li>
                                                                    <a href="{{ url("shop/wishlist-add/{$product}") }}">
                                                                        <span class=flaticon-heart></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ url("shop/quick-look/{$product->slug}") }}"><span
                                                                            class=flaticon-show></span></a></li>
                                                                <li><a href=""><span
                                                                            class=flaticon-graph></span></a></li>
                                                            </ul>
                                                        ...
                                                        <div class="shop_item_cart_btn d-grid"><a
                                                                href="{{ url("shop/cart-add/{$product}") }}" class="btn btn-thm">Add
                                                                to Cart</a></div>
                                                    </div>
                                                    <div class=details>
                                                        <div class=sub_title>{{ $product->brand }}</div>
                                                        <div class=title><a href="{{ url("shop/product/{$product->slug}")}}">{{ $product->name }}</a>
                                                        </div>
                                                        <div class="review d-flex db-500">
                                                            <ul class="mb0 me-2">
