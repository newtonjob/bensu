    ...
    <div class="app-container  container-fluid d-flex align-items-stretch justify-content-between "
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="index.html" class="d-lg-none">
                <img alt="Logo" src="{{ asset('admin/media/logos/default-small.svg') }}" class="theme-light-show h-30px"/>
                <img alt="Logo" src="{{ asset('admin/media/logos/default-small-dark.svg') }}" class="theme-dark-show h-30px"/>
            </a>
        </div>
        <!--end::Mobile logo-->
                                    ...
                                    <ul class="nav nav-stretch nav-line-tabs fw-semibold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1">
                                        ...
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 active text-active-primary"
                                               href="index.html#" data-bs-toggle="tab"
                                ...
                                <div class="tab-content py-4 py-lg-8 px-lg-7">
                                    ...
                                    <div class="tab-pane active w-lg-1000px"
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-4">
                                                <img src="{{ asset('admin/media/stock/600x600/img-82.jpg') }}"
                                    ...
                                    <div class="tab-pane  w-lg-600px" id="kt_app_header_menu_pages_account">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                                <img src="{{ asset('admin/media/stock/900x600/46.jpg') }}"
                                                     class="rounded mw-100" alt=""/>
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                    ...
                                    <div class="tab-pane  w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 pe-lg-5">
                                                <img src="{{ asset('admin/media/stock/600x600/img-84.jpg') }}"
                                                     class="rounded mw-100" alt=""/>
                                            </div>
                                            <!--end:Col-->
                                        </div>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
...
<path
    ...
    fill="currentColor"/>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm001.svg-->
<span class="svg-icon svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/general/gen051.svg-->
<span class="svg-icon svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
...
<path
    ...
    fill="currentColor"/>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/electronics/elc002.svg-->
<span class="svg-icon svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
<span class="svg-icon svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/files/fil025.svg-->
<span class="svg-icon svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
                            ...
                            <div class="menu-state-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 mb-3 pt-2 pe-lg-8">
                                        <img src="{{ asset('admin/media/stock/900x600/74.jpg') }}" class="rounded mw-100"
                                             alt=""/>
                                    </div>
                                    <!--end:Col-->
                                </div>
...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                                        ...
                                        <!--end::Svg Icon--></span><span
                                        class="menu-title">Changelog v3.0.3</span></a><!--end:Menu link--></div>
      ...
      fill="currentColor"/>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                             style="background-image:url('{{ asset('admin/media/misc/menu-header-bg.jpg.png') }}')">
                            <!--begin::Title-->
                            ...
                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                       data-bs-toggle="tab"
                                       href="index.html#kt_topbar_notifications_1">Alerts</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
                                       data-bs-toggle="tab"
                                       href="index.html#kt_topbar_notifications_2">Updates</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                       data-bs-toggle="tab" href="index.html#kt_topbar_notifications_3">Logs</a>
                                </li>
                            </ul>
                            <!--end::Tabs-->
                        </div>
...
<span class="svg-icon svg-icon-2 svg-icon-danger"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                       xmlns="http://www.w3.org/2000/svg">
...
<span class="svg-icon svg-icon-2 svg-icon-warning"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
      d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z"
      fill="currentColor"/>
...
<span class="svg-icon svg-icon-2 svg-icon-success"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
...
<span class="svg-icon svg-icon-2 svg-icon-info"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
...
<path
    ...
    fill="currentColor"/>
                                ...
                                <span class="symbol-label bg-light-warning">
                                    <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
<span class="svg-icon svg-icon-2 svg-icon-warning"><svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3"
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        ...
                                        <div class="text-center mt-5 mb-9">
                                            <a href="index.html#" class="btn btn-sm btn-primary px-6"
...
<rect x="6" y="7" width="12" height="2" rx="1" fill="currentColor"/>
            ...
            <span class="symbol symbol-20px">
                <img class="rounded" src="{{ asset('admin/media/flags/united-states.svg') }}" alt=""/>
            </span>
                    </div>
    ...
    fill="currentColor"/>
                    ...
                    <div
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="index.html#" class="menu-link px-3 py-2" data-kt-element="mode"
                               data-kt-value="light">
      ...
      fill="currentColor"/>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                         data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                         data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('admin/media/avatars/300-3.jpg') }}" alt="user"/>
                    </div>
            ...
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('admin/media/flags/united-states.svg') }}"
                                 alt=""/>
                </span>
            </span>
                            </a>
