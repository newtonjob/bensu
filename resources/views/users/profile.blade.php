                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex flex-stack align-items-end pb-4 mt-n19">
                                <div class="symbol symbol-125px symbol-lg-150px symbol-fixed position-relative mt-n3">
                                    <img src="{{ asset('media/avatars/300-3.jpg') }}" alt="image"
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="settings.html#"
                                           class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Bessie
                                            Cooper</a>
                                        <a href="settings.html#" class="" data-bs-toggle="tooltip"
  ...
  <path
      ...
      fill="white"/>
                        ...
                        Design is like a fart. If you have to force it, it’s probably shit.
                                ...
                                <!--begin::Actions-->
                                <div class="d-flex">
                                    <a href="settings.html#" class="btn btn-sm btn-light me-3"
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                 style="background-image: url('{{ asset('media/avatars/300-1.jpg') }}')"></div>
    ...
    fill="currentColor"/>
                                ...
                                <div class="d-flex flex-stack flex-grow-1 ">
                                    ...
                                    <div class=" fw-semibold">
                                        ...
                                        <div class="fs-6 text-gray-700 ">Two-factor authentication adds an extra layer
                                            of security to your account. To log in, in you'll need to provide a 4 digit
                                            amazing code. <a href="settings.html#" class="fw-bold">Learn More</a></div>
                                    </div>
                                    <!--end::Content-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_email_preferences" class="collapse show">
                        ...
                        <form class="form">
                            ...
                            <span
                                class="text-muted fs-6">Receive a notification each time you collect a fee from sales</span>
                        </span>
                                    <!--end::Label-->
                                </label>
                                <!--end::Option-->
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 ">
                                        ...
                                        <div class=" fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700 ">For extra security, this requires you to
                                                ...
                                                <br/><a class="fw-bold" href="settings.html#">Learn more</a></div>
                                        </div>
                                        <!--end::Content-->
