            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="settings.html#" class="btn btn-icon btn-sm btn-success flex-shrink-0 ms-4"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
                            ...
                            <div class="d-flex flex-stack align-items-end pb-4 mt-n19">
                                ...
                                <div class="me-0">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="settings.html#" class="menu-link px-3">
                                                Create Invoice
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="settings.html#" class="menu-link flex-stack px-3">
                                                Create Payment
                            ...
                            <div class="d-flex flex-stack flex-wrap align-items-end">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="settings.html#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Bessie Cooper</a>
                                        <a href="settings.html#" class="" data-bs-toggle="tooltip" data-bs-placement="right" title="Account is verified">
  ...
  <path d="M14.8563 9.1903C15.0606 8.94984 15.3771 8.9385 15.6175 9.14289C15.858 9.34728 15.8229 9.66433 15.6185 9.9048L11.863 14.6558C11.6554 14.9001 11.2876 14.9258 11.048 14.7128L8.47656 12.4271C8.24068 12.2174 8.21944 11.8563 8.42911 11.6204C8.63877 11.3845 8.99996 11.3633 9.23583 11.5729L11.3706 13.4705L14.8563 9.1903Z" fill="white"/>
                        ...
                        Design is like a fart. If you have to force it, it’s probably shit.
                                    ...
                                    <div class="d-flex align-items-center flex-wrap fw-semibold fs-7 pe-2">
                                        <a href="settings.html#" class="d-flex align-items-center text-gray-400 text-hover-primary">
                                            UI/UX Design
                                        </a>
                                        ...
                                        <span class="bullet bullet-dot h-5px w-5px bg-gray-400 mx-3"></span>
                                        <a href="settings.html#" class="text-gray-400 text-hover-primary">
                                            3,450 Followers
                                        </a>
                                    </div>
                                    <!--end::Info-->
                                ...
                                <!--begin::Actions-->
                                <div class="d-flex">
                                    <a href="settings.html#" class="btn btn-sm btn-light me-3" id="kt_drawer_chat_toggle">Send Message</a>
...
<path d="M10.5606 11.3042L9.57283 10.3018C9.28174 10.0065 8.80522 10.0065 8.51412 10.3018C8.22897 10.5912 8.22897 11.0559 8.51412 11.3452L10.4182 13.2773C10.8099 13.6747 11.451 13.6747 11.8427 13.2773L15.4859 9.58051C15.771 9.29117 15.771 8.82648 15.4859 8.53714C15.1948 8.24176 14.7183 8.24176 14.4272 8.53714L11.7002 11.3042C11.3869 11.6221 10.874 11.6221 10.5606 11.3042Z" fill="currentColor"/>
                                ...
                                <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                    ...
                                    <!--begin::Action-->
                                    <a href="settings.html#" class="btn btn-primary px-6 align-self-center text-nowrap"  data-bs-toggle="modal" data-bs-target="#kt_modal_two_factor_authentication" >
                                        Enable            </a>
                                    <!--end::Action-->
                                </div>
                                <!--end::Wrapper-->
...
<path d="M20 5V21C20 21.6 19.6 22 19 22H17C16.4 22 16 21.6 16 21V8H8V4H19C19.6 4 20 4.4 20 5ZM3 8H4V4H3C2.4 4 2 4.4 2 5V7C2 7.6 2.4 8 3 8Z" fill="currentColor"/>
                                ...
                                <div class="d-flex flex-stack flex-grow-1 ">
                                    ...
                                    <div class=" fw-semibold">
                                        ...
                                        <div class="fs-6 text-gray-700 ">Two-factor authentication adds an extra layer of security to your account. To log in, in you'll need to provide a 4 digit amazing code. <a href="settings.html#" class="fw-bold">Learn More</a></div>
                                    </div>
                                    <!--end::Content-->
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="settings.html#" class="fs-5 text-dark text-hover-primary fw-bold">Google</a>
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="settings.html#" class="fs-5 text-dark text-hover-primary fw-bold">Github</a>
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="settings.html#" class="fs-5 text-dark text-hover-primary fw-bold">Slack</a>
...
<rect x="11" y="17" width="2" height="2" rx="1" transform="rotate(-90 11 17)" fill="currentColor"/>
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 ">
                                        ...
                                        <div class=" fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700 ">For extra security, this requires you to confirm your email or phone number when you reset yousignr password. <br/><a class="fw-bold" href="settings.html#">Learn more</a></div>
                                        </div>
                                        <!--end::Content-->
